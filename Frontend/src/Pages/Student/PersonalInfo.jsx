...
const PersonalInfoStd = () => {
  ...
  const roll = studentInfo?.rollNo || studentInfo?.rollNo_id || "N/A";
  const fname = studentInfo?.fName || "";
  const mName = studentInfo?.mName || "";
  const lname = studentInfo?.lName || "";
  const Class = studentInfo?.Class || "N/A";
  const semester = studentInfo?.semester || "N/A";
...
export default PersonalInfoStd;
