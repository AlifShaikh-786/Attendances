...
export default function AttendanceForm() {
  ...
  // const [subjectWiseByStudent, setSubjectWiseByStudent] = useState([]);
  ...
  const facultyId_id = studentInfo?.facultyId_id;
  // const Subject = studentInfo?.Subject;
  ...
  const StdDetailSubmit = async (e) => {
    ...
    try {
      ...
      if (res.data.success) {
        ...
        // }
        if (facultyId_id && facultyId_id !== "N/A") {
          filtered = filtered.filter((r) => r.facultyId_id === facultyId_id);
        }
        ...
        // setSubjectWiseByStudent(calculateSubjectWiseByStudent(filtered));
  ...
  // const calculateSubjectWiseByStudent = (attendanceRecords) => {
  ...
  //     studentSubjectStats[key].totalLectures += 1;
  //     if (rec.status === "Present") {
  //       studentSubjectStats[key].present += 1;
  //     } else {
  //       studentSubjectStats[key].absent += 1;
  //     }
  //   });

  //   return Object.values(studentSubjectStats).map((s) => ({
  //     ...s,
  //     percentage: ((s.present / s.totalLectures) * 100).toFixed(2),
  //   }));
  // };
  // Inside your AttendanceForm component, before the return block

  // const { report, allSubjects } = calculateStudentSubjectReport(students);
          ...
          <table className="w-full border-collapse border border-gray-400 mt-4">
            <thead>
              <tr className="bg-gray-200">
                ...
                <th className="border px-4 py-2">subject name2</th> */}
          ...
          <table className="w-full border-collapse">
            ...
            <tbody>
              {students.map((student, i) => (
                ...
                >
                  <td className="border px-2 py-2">{student.rollNo_id}</td>
                  <td className="border px-2 py-2">{student.fName}</td>
                  <td className="border px-2 py-2">{student.mName}</td>
                  <td className="border px-2 py-2">{student.lName}</td>
                  <td className="border px-2 py-2">{student.Class}</td>
                  <td className="border px-2 py-2">{student.semester}</td>
                  <td className="border px-2 py-2">{student.div}</td>
                  <td className="border px-2 py-2">{student.Subject}</td>
                  <td className="border px-2 py-2">{student.facultyId_id}</td>
                  <td className="border px-2 py-2">{student.department}</td>
                  <td className="border px-2 py-2">{student.Time || "-"}</td>
