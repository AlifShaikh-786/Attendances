...
const HodDashBoard = () => {
  ...
  const sections = {
    ...
    DisplyApplication: {
      title: "Application",
      component: <DisplyApplication />,
    },
    TeacherInfo: { title: "Teacher Info", component: <FacultyInfo /> },
    StudentInfo: { title: "Student Info", component: <StudentInfo /> },
    EditReports: { title: "Edit Student Reports", component: <Report /> },
  };
  ...
  return (
    <div className="flex min-h-screen bg-gray-900 text-black">
      {/* Sidebar (Desktop) */}
      <aside className="hidden md:flex fixed top-0 left-0 h-full w-[20%] bg-gray-800 p-8 flex-col overflow-y-auto">
